package suffixArray.Lesson2.ProblemA;
...
public class Solution {
    ...
    private static int[] getSuffixMassive(String s) {
        ...
        System.out.println("Массив классов эквивалентностей " + Arrays.toString(c));
        System.out.println("Суффиксный массив " + Arrays.toString(p));
        return p;
    }
